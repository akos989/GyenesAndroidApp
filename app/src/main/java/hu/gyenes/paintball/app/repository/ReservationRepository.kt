...
class ReservationRepository(val db: GyenesPaintballDatabase) : Synchronizable {
    ...
    private suspend fun remoteFindAll(): List<Reservation> {
        ...
        list.add(Reservation(1000.toString(), "János János", "morvaiakos@asdlf.com", "021234123", 16, Date(), 700.toString(), Date()))
        list.add(Reservation(2000.toString(), "Béla Béla", "morvaiakos@asdlf.com", "021234123", 16, Date(), 100.toString(), Date()))
        return list
    }
